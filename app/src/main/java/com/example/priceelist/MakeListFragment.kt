...
class MakeListFragment : Fragment() {
    ...
    private val navigationArgs: MakeListFragmentArgs by navArgs() //(to be used later)
    ...
    private val listTypePricelist: String = "Pl"
    ...
    private fun isSavePossible(): Boolean {
        return viewModel.isSavePossible(
            binding.title.text.toString(), binding.item1.text.toString(), binding.unit1.text.toString(), binding.amount1.text.toString(),
            binding.item2.text.toString(), binding.unit2.text.toString(), binding.amount2.text.toString(),
            binding.item3.text.toString(), binding.unit3.text.toString(), binding.amount3.text.toString(),
            binding.item4.text.toString(), binding.unit4.text.toString(), binding.amount4.text.toString(),
            binding.item5.text.toString(), binding.unit5.text.toString(), binding.amount5.text.toString(),
            binding.item6.text.toString(), binding.unit6.text.toString(), binding.amount6.text.toString(),
            binding.item7.text.toString(), binding.unit7.text.toString(), binding.amount7.text.toString(),
            binding.item8.text.toString(), binding.unit8.text.toString(), binding.amount8.text.toString(),
            binding.item9.text.toString(), binding.unit9.text.toString(), binding.amount9.text.toString(),
            binding.item10.text.toString(), binding.unit10.text.toString(), binding.amount10.text.toString(),
            binding.item11.text.toString(), binding.unit11.text.toString(), binding.amount11.text.toString(),
            binding.item12.text.toString(), binding.unit12.text.toString(), binding.amount12.text.toString(),
            binding.item13.text.toString(), binding.unit13.text.toString(), binding.amount13.text.toString(),
            binding.item14.text.toString(), binding.unit14.text.toString(), binding.amount14.text.toString(),
            binding.item15.text.toString(), binding.unit15.text.toString(), binding.amount15.text.toString()
        )
    }

    //The ADD NEW LIST Section : Functions for adding a new list begin hre
     ...
     * This is not a good logic or UX method however, the system must get the sum total of the
    ...
    private fun getSumTotal(): String {
        ...
        var unit9 = binding.unit6.text.toString().toDoubleOrNull()
        if (unit9 == null) {
            unit9 = 1.0
        }
    ...
    private fun addNewList() {
         ...
         * a list via the done button i.e. the button is diasbled.
         */
        if (isSavePossible()) {

            viewModel.addnewList(
                createListTitle(), calendarDate,
                binding.item1.text.toString(), binding.unit1.text.toString(), binding.amount1.text.toString(),
                binding.item2.text.toString(), binding.unit2.text.toString(), binding.amount2.text.toString(),
                binding.item3.text.toString(), binding.unit3.text.toString(), binding.amount3.text.toString(),
                binding.item4.text.toString(), binding.unit4.text.toString(), binding.amount4.text.toString(),
                binding.item5.text.toString(), binding.unit5.text.toString(), binding.amount5.text.toString(),
    ...
    //previously used this function (below) ...
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (id > 0) {
            viewModel.retrieveList(id).observe(this.viewLifecycleOwner) { selectedItem ->
                //if selectedItem is null, do something
                item = selectedItem
                bindToFields(item)
            }
        } else {
    ...
    private fun displayTotal(sumTotal: Double) {
        val formattedTotal = NumberFormat.getCurrencyInstance().format(sumTotal) //here, sumTotal is the parameter above
