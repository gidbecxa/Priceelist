...
class PricelistViewModel(private val pricelistDao: PricelistDao): ViewModel() {
     ...
     */
    private fun getNewListEntry (dbListTitle: String, date: String,
                                dbItem1: String, dbQuantity1: String, dbAmount1: String,
                                 ...
                                 dbItem15: String, dbQuantity15: String, dbAmount15: String, dbTotal: String, listType: String): Pricelist {
        return Pricelist(
            dbListTitle = dbListTitle, date = date,
            dbItem1 = dbItem1, dbQuantity1 = dbQuantity1.toDoubleOrNull(), dbAmount1 = dbAmount1.toDoubleOrNull(),
            dbItem2 = dbItem2, dbQuantity2 = dbQuantity2.toDoubleOrNull(), dbAmount2 = dbAmount2.toDoubleOrNull(),
            dbItem3 = dbItem3, dbQuantity3 = dbQuantity3.toDoubleOrNull(), dbAmount3 = dbAmount3.toDoubleOrNull(),
            dbItem4 = dbItem4, dbQuantity4 = dbQuantity4.toDoubleOrNull(), dbAmount4 = dbAmount4.toDoubleOrNull(),
            dbItem5 = dbItem5, dbQuantity5 = dbQuantity5.toDoubleOrNull(), dbAmount5 = dbAmount5.toDoubleOrNull(),
            dbItem6 = dbItem6, dbQuantity6 = dbQuantity6.toDoubleOrNull(), dbAmount6 = dbAmount6.toDoubleOrNull(),
            dbItem7 = dbItem7, dbQuantity7 = dbQuantity7.toDoubleOrNull(), dbAmount7 = dbAmount7.toDoubleOrNull(),
            dbItem8 = dbItem8, dbQuantity8 = dbQuantity8.toDoubleOrNull(), dbAmount8 = dbAmount8.toDoubleOrNull(),
            dbItem9 = dbItem9, dbQuantity9 = dbQuantity9.toDoubleOrNull(), dbAmount9 = dbAmount9.toDoubleOrNull(),
            dbItem10 = dbItem10, dbQuantity10 = dbQuantity10.toDoubleOrNull(), dbAmount10 = dbAmount10.toDoubleOrNull(),
            dbItem11 = dbItem11, dbQuantity11 = dbQuantity11.toDoubleOrNull(), dbAmount11 = dbAmount11.toDoubleOrNull(),
            dbItem12 = dbItem12, dbQuantity12 = dbQuantity12.toDoubleOrNull(), dbAmount12 = dbAmount12.toDoubleOrNull(),
            dbItem13 = dbItem13, dbQuantity13 = dbQuantity13.toDoubleOrNull(), dbAmount13 = dbAmount13.toDoubleOrNull(),
            dbItem14 = dbItem14, dbQuantity14 = dbQuantity14.toDoubleOrNull(), dbAmount14 = dbAmount14.toDoubleOrNull(),
            dbItem15 = dbItem15, dbQuantity15 = dbQuantity15.toDoubleOrNull(), dbAmount15 = dbAmount15.toDoubleOrNull(),
            dbTotal = dbTotal.toDouble(), listType = listType
        )
    }

    fun addnewList (dbListTitle: String, date: String,
                 dbItem1: String, dbQuantity1: String, dbAmount1: String,
                 dbItem2: String, dbQuantity2: String, dbAmount2: String,
                 dbItem3: String, dbQuantity3: String, dbAmount3: String,
                 dbItem4: String, dbQuantity4: String, dbAmount4: String,
                 ...
                 dbItem13: String, dbQuantity13: String, dbAmount13: String,
                 dbItem14: String, dbQuantity14: String, dbAmount14: String,
                 dbItem15: String, dbQuantity15: String, dbAmount15: String, dbTotal: String, listType: String) {
        val newList = getNewListEntry(dbListTitle, date,
                                     ...
                                     dbItem15, dbQuantity15, dbAmount15, dbTotal, listType)
    ...
    fun updateList (itemId: Int,
                    ...
                    dbItem14: String, dbQuantity14: String, dbAmount14: String,
                    dbItem15: String, dbQuantity15: String, dbAmount15: String, dbTotal: String, listType: String) {
        val updatedList = getUpdatedEntry(itemId, dbListTitle, date,
                            dbItem1, dbQuantity1, dbAmount1,
                            dbItem2, dbQuantity2, dbAmount2,
                            dbItem3, dbQuantity3, dbAmount3,
                            dbItem4, dbQuantity4, dbAmount4,
    ...
    fun isSavePossible(dbListTitle: String,
                         dbItem1: String, dbQuantity1: String, dbAmount1: String,
                         dbItem2: String, dbQuantity2: String, dbAmount2: String,
                         dbItem3: String, dbQuantity3: String, dbAmount3: String,
                         dbItem4: String, dbQuantity4: String, dbAmount4: String,
                         ...
                         dbItem13: String, dbQuantity13: String, dbAmount13: String,
                         dbItem14: String, dbQuantity14: String, dbAmount14: String,
                         dbItem15: String, dbQuantity15: String, dbAmount15: String): Boolean {
        if ( dbListTitle.isBlank() && dbItem1.isBlank() && dbQuantity1.isBlank() && dbAmount1.isBlank()
...
class PricelistViewModelFactory(private val pricelistDao: PricelistDao): ViewModelProvider.Factory{
