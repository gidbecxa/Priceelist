...
class MenuDialogFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.menuBackground.setBackgroundResource(R.drawable.background)
        binding.menuBackground.clipToOutline = true

        val id = navigationArgs.itemId

        viewModel.retrieveList(id).observe(this.viewLifecycleOwner) {selectedItem ->
            /**
             * condition was added to solve an app crash issue: Java Null Pointer Exception...
    ...
    private val listsScreen = SavedListsFragment()
